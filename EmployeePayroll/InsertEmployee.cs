...
namespace EmployeePayroll
{
    ...
    public class InsertEmployee
    {
        ...
        string connectionString = @"Data Source=IN-100N0F3;Initial Catalog=EmployeePayrollDB;Integrated Security=True";
        ...
        public bool RegisterEmployee()
        {
            ...
            try
            {
                ...
                command.Parameters.AddWithValue("Note", employee.Notes);
